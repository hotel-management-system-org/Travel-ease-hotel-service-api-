...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        ...
        http.authorizeHttpRequests(autherize->{
            autherize
            .requestMatchers("/hotel-service/api/v1/hotels/visitors/**").permitAll()
            .requestMatchers("/hotel-service/api/v1/hotels/policy/visitors/**").permitAll()
            .requestMatchers("/hotel-service/api/v1/rooms/visitor/**").permitAll()
            .requestMatchers("/hotel-service/api/v1/rooms/internal/**").permitAll()
