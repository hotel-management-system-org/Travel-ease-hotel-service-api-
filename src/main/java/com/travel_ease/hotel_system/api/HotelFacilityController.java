...
@RequestMapping("/hotel-management/api/v1/hotel-facilities")
public class HotelFacilityController {
    ...
    public ResponseEntity<StandardResponseDto> create(
            @RequestBody HotelFacilityRequestDto dto) {
    ...
    public ResponseEntity<StandardResponseDto> update(
            ...
            @RequestBody HotelFacilityRequestDto dto) throws SQLException {
